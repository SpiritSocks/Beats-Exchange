  ...
  if (isLoading || !genre) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
        <p className="font-black uppercase tracking-widest text-xs">Загрузка жанра...</p>
      </div>
    );
  }
        ...
        <div className="flex flex-col gap-12">
          ...
          {beats.length === 0 ? (
            <div className="py-20 text-center border-2 border-dashed border-foreground/20">
              <p className="font-black uppercase italic text-muted-foreground tracking-widest">В этом жанре битов пока нет</p>
            </div>
          ) : (
